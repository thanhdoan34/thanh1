 ...
 * 
 */
@WebServiceClient(name = "LoginWebService", targetNamespace = "http://service.exmple.com/", wsdlLocation = "http://localhost:8080/EJB1-war/LoginWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGINWEBSERVICE_QNAME = new QName("http://service.exmple.com/", "LoginWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EJB1-war/LoginWebService?WSDL");
    ...
    public LoginWebService getLoginWebServicePort() {
        return super.getPort(new QName("http://service.exmple.com/", "LoginWebServicePort"), LoginWebService.class);
    }
    ...
    public LoginWebService getLoginWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.exmple.com/", "LoginWebServicePort"), LoginWebService.class, features);
    }
